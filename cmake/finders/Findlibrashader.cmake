...
find_package_handle_standard_args(
  ...
  VERSION_VAR librashader_VERSION REASON_FAILURE_MESSAGE "${librashader_ERROR_REASON}")
...
if(librashader_FOUND)
  if(NOT TARGET librashader::librashader)
    if(poop)
      if(IS_ABSOLUTE "${librashader_LIBRARY}")
        add_library(librashader::librashader UNKNOWN IMPORTED)
        set_property(TARGET MoltenVK::MoltenVK PROPERTY IMPORTED_LOCATION "${librashader_LIBRARY}")
      else()
        add_library(librashader::librashader SHARED IMPORTED)
        set_property(TARGET MoltenVK::MoltenVK PROPERTY IMPORTED_LIBNAME "${librashader_LIBRARY}")
      endif()
    endif()
    ...
    set_target_properties(
      librashader::librashader
      PROPERTIES INTERFACE_COMPILE_OPTIONS "${PC_librashader_CFLAGS_OTHER}"
...
set_package_properties(
  librashader PROPERTIES
  URL "https://github.com/SnowflakePowered/librashader"
  DESCRIPTION "librashader (/ˈli:brəʃeɪdɚ/) is a preprocessor, compiler, and runtime for RetroArch 'slang' shaders, rewritten in pure Rust.")
