...
if(CMAKE_HOST_SYSTEM_NAME MATCHES "Darwin|Windows")
  set(MoltenVK_ERROR_REASON "Ensure that obs-deps is provided as part of CMAKE_PREFIX_PATH.")
elseif(CMAKE_HOST_SYSTEM_NAME MATCHES "Linux|FreeBSD")
  set(MoltenVK_ERROR_REASON "Ensure MoltenVK libraries are available in local library paths.")
endif()

find_package_handle_standard_args(
  MoltenVK
  REQUIRED_VARS MoltenVK_LIBRARY
  VERSION_VAR MoltenVK_VERSION REASON_FAILURE_MESSAGE "${MoltenVK_ERROR_REASON}")
...
if(MoltenVK_FOUND)
  if(NOT TARGET MoltenVK::MoltenVK)
    ...
    set_target_properties(
      MoltenVK::MoltenVK
      PROPERTIES INTERFACE_COMPILE_OPTIONS "${PC_MoltenVK_CFLAGS_OTHER}"
