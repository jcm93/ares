...
if(CMAKE_HOST_SYSTEM_NAME MATCHES "Darwin|Windows")
  set(SDL_ERROR_REASON "Ensure that obs-deps is provided as part of CMAKE_PREFIX_PATH.")
elseif(CMAKE_HOST_SYSTEM_NAME MATCHES "Linux|FreeBSD")
...
find_package_handle_standard_args(
  ...
  VERSION_VAR SDL_VERSION REASON_FAILURE_MESSAGE "${SDL_ERROR_REASON}")
...
if(SDL_FOUND)
  if(NOT TARGET SDL::SDL)
    ...
    set_target_properties(
      SDL::SDL
      PROPERTIES INTERFACE_COMPILE_OPTIONS "${PC_SDL_CFLAGS_OTHER}"
