...
"                    .-::::::::    / /_/ / /  /  __(__  )\n"
"                      .::::.      \\__,_/_/   \\___/____/\n"
    "\nares:  Application Version: ${ARES_VERSION} - Build Number: ${ARES_BUILD_NUMBER}\n"
    "==================================================================================\n\n")

  get_property(ARES_FEATURES_ENABLED GLOBAL PROPERTY ARES_FEATURES_ENABLED)
  list(
    SORT ARES_FEATURES_ENABLED
    COMPARE NATURAL
    CASE SENSITIVE
    ORDER ASCENDING)
