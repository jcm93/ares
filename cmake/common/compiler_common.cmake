...
set(_ares_clang_common_options
    -fno-strict-aliasing
    -Wno-trigraphs
    ...
    $<$<BOOL:${ARES_COMPILE_DEPRECATION_AS_WARNING}>:-Wno-error=deprecated-declarations>)

# clang options for C
set(_ares_clang_c_options ${_ares_clang_common_options} -Wno-shadow -Wno-float-conversion)

# clang options for C++
set(_ares_clang_cxx_options
