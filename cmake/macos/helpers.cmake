  ...
  foreach(library IN LISTS found_dependencies)
    ...
    if(is_imported)
      ...
      if(NOT imported_location)
        message(DEBUG "no imported location for library ${library}- skipping")
        continue()
      endif()
      ...
      if(is_system_framework OR is_xcode_framework)
        message(DEBUG "system or xcode framework for library ${library}- skipping")
        continue()
      elseif(is_framework)
      ...
      elseif(NOT library_type STREQUAL "STATIC_LIBRARY")
        if(NOT imported_location MATCHES ".+\\.a")
          ...
          message(DEBUG "not static library, but is .a for library ${library}- skipping")
          continue()
        endif()
      else()
        message(DEBUG "static library for library ${library}- skipping")
        continue()
      endif()
      ...
      message(DEBUG "appending to bundled_targets ${library}")
    ...
    elseif(NOT is_imported AND library_type STREQUAL "SHARED_LIBRARY")
      message(DEBUG "not imported shared library for ${library}- skipping")
      list(APPEND library_paths ${library})
    else()
      message(DEBUG "mystery for library ${library}- skipping")
    endif()
  endforeach()
