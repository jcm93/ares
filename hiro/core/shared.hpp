...
struct Toolbar : sToolbar {
  ...
  auto navigation() const { return self().navigation(); }
  auto onChange(const std::function<void ()>& callback = {}) { return self().onChange(callback), *this; }
  auto onClose(const std::function<void (sToolbarItem)>& callback = {}) { return self().onClose(callback), *this; }
  auto onMove(const std::function<void (sToolbarItem, sToolbarItem)>& callback = {}) { return self().onMove(callback), *this; }
