...
auto mToolbar::onChange(const std::function<void ()>& callback) -> type& {
  state.onChange = callback;
  return *this;
}

auto mToolbar::onClose(const std::function<void (ToolbarItem)>& callback) -> type& {
  state.onClose = callback;
  return *this;
}

auto mToolbar::onMove(const std::function<void (ToolbarItem, ToolbarItem)>& callback) -> type& {
