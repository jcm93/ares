...
auto SystemInputSettings::systemChange() -> void {
  portList.reset();
...
auto SystemInputSettings::eventInput(shared_pointer<HID::Device> device, u32 groupID, u32 inputID, s16 oldValue, s16 newValue) -> void {
...
auto SystemInputSettings::inputRefresh() -> void {
