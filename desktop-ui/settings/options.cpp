auto OptionSettings::construct() -> void {
  ...
  gameBoyPlayerOption.setText("Game Boy Player").setChecked(settings.gameBoyAdvance->system.player).onToggle([&] {
    settings.gameBoyAdvance->system.player = gameBoyPlayerOption.checked();
  });
