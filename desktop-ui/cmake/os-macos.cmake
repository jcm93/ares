...
function(target_install_shaders target)
  ...
  if(EXISTS "${CMAKE_SOURCE_DIR}/.deps/obs-deps-ares-universal/lib/slang-shaders")
    file(GLOB_RECURSE data_files "${CMAKE_SOURCE_DIR}/.deps/obs-deps-ares-universal/lib/slang-shaders/*")
    foreach(data_file IN LISTS data_files)
      cmake_path(RELATIVE_PATH data_file BASE_DIRECTORY "${CMAKE_SOURCE_DIR}/.deps/obs-deps-ares-universal/lib/slang-shaders/" OUTPUT_VARIABLE
                 relative_path)
...
function(target_install_database target)
  ...
  if(EXISTS "${CMAKE_SOURCE_DIR}/mia/Database")
    ...
    foreach(data_file IN LISTS data_files)
      cmake_path(RELATIVE_PATH data_file BASE_DIRECTORY "${CMAKE_SOURCE_DIR}/mia/Database/" OUTPUT_VARIABLE
                 relative_path)
      cmake_path(GET relative_path PARENT_PATH relative_path)
      target_sources(${target} PRIVATE "${data_file}")
